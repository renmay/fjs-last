<!--<template>-->
  <!--<div>-->
    ...
    <!--<div id="indexHeader">-->
      <!--<nav>-->
        <!--<div class="nav_ul">-->
          <!--<a href='javascript:;' :class='{active: currentIndexcurrentIndex === -1}' @click.stop="first()">推荐</a>-->
          <!--<a href='javascript:;' v-for="(item,index) in newsCatListData" :class='{active: currentIndex === item.id}'-->
             <!--@click.stop="navClick(item.id)" :key="index">{{item.title}}</a>-->
        <!--</div>-->
      <!--</nav>-->
    <!--</div>-->
    <!--<div class="news-list">-->
