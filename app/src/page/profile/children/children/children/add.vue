 <template>
  <div class="rating_page">
        <head-top head-title="新增收获地址" go-back='true'></head-top>
        	...
        	<form action="" v-on:submit.prevent>
        		<section class="ui-padding-block">
        			...
        			<router-link to='/profile/info/address/add/addDetail' class="add-detail">
        			 ...
        			 <div class="input-new">
        				<input type="text" placeholder="详细地址" :class="{verifies:verifythree}" @input="inputThingthree" v-model="mesthree"/>
        				<p v-if="verifythree">{{sendaddress}}</p>
        			</div>
        			<div class="input-new">
        				<input type="text" placeholder="手机号" :class="{verifies:verifyfour}" v-model="telenum" @input="inputThingfour" />
        				<p v-if="verifyfour">{{telephone}}</p>
        			</div>
        			<div class="input-new">
        				<input type="text" placeholder="备用联系电话" v-model="standbytelenum" @input="inputThingfive" />
